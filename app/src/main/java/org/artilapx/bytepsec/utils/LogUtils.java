...
public class LogUtils implements Thread.UncaughtExceptionHandler {
    ...
    private void upgrade() {
        ...
        try {
            ...
            ostream.write(("Init logger: " + TimeUtils.getReadableDateTime(System.currentTimeMillis())
